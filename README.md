...
即IDLE：空闲状态  OFFSET_CALIB:自举电容充电  ALIGN：转子对齐  OPEN_LOOP：开环启动  RUN：观察器运行  
其中OPEN_LOOP：内部分出SWITCH_OVER子状态，用于观察器的切换判断
...
### 项目展示
<img width="240" height="427" alt="mmexport1778571526265" src="https://github.com/user-attachments/assets/b0849a63-41eb-41e6-970c-3f10f1c8a975" />
...
本项目做了如下测试，以下仅为部分展示
<img width="339" height="458" alt="image" src="https://github.com/user-attachments/assets/1f18ebfb-5d30-4c78-befb-accf96b36edc" />

#### TIM1PWM测试
E01_PA8_PA9_PA10_三相高边PWM
<img width="1024" height="600" alt="E01_PA8_PA9_PA10_三相高边PWM" src="https://github.com/user-attachments/assets/6bd0f0ce-446f-4820-87fe-97fe40b6af8c" />

E02_U相_PA8_PB13_互补PWM
<img width="1024" height="600" alt="E02_U相_PA8_PB13_互补PWM" src="https://github.com/user-attachments/assets/d25d9654-ced2-4b4c-8d89-35a93e7b8204" />
...
### 电流环仿真
本项目做了基础功能模块、电流环、观察器+PLL、开环启动、handover阶段切换5个模型，并进行MIL测试，以下仅为部分展示
#### iq电流环离散跟踪
