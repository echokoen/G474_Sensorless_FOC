                        ...
                        float vbeta)
{
   ...
   */
  observer->flux_obs.Ialpha_I = current_sense->iu_a;
  observer->flux_obs.Ibeta_I = (current_sense->iu_a + 2.0f * current_sense->iv_a) * 0.57735026919f;
