...
#define FOC_IQ_REF_A                 (0.2f)      /* q 轴电流参考，增加低速开环跟随转矩。 */
...
#define FOC_ALIGN_VDQ_V              (2.0f)      /* 对齐阶段给定的小幅 d 轴电压，主要用于找初始角。 */
...
#define FOC_OPENLOOP_TARGET_FREQ_HZ  (10.0f)      /* I/F 低速调试目标机械频率。 */
#define FOC_OPENLOOP_RAMP_TIME_MS    (2000.0f)   /* 低速测试阶段放慢爬坡，方便观察 id/iq 方向。 */
